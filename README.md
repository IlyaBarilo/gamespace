...
Работа PWA 0.3.7 подтверждена на iPhone 17 Pro с iOS 26.5.2: приложение
установлено через меню Добавить на экран «Домой», демо-архив загружен,
работа его содержимого проверена успешно.
