...
## Полевое применение первого поколения

27 июня 2026 года первое монолитное поколение GameSpace использовалось на
открытой площадке Дня молодёжи. На четырёх планшетах были заранее установлены
единая оболочка, каталог и игры. Доступного мобильного интернета на площадке не
было, поэтому локальная работа являлась не запасным режимом, а необходимым
условием запуска.

Сохранённые фотографии показывают, как посетители запускали игры
непосредственно на планшетах у стенда. Заряда устройств хватило на всё
мероприятие; подготовленный внешний аккумулятор использовать не потребовалось.

Источник: [пост о применении GameSpace на Дне молодёжи 27 июня 2026 года](https://vk.ru/id4022887?w=wall4022887_1724).
В репозитории опубликованы копии фотографий с размытыми лицами посетителей.

<table>
  <tr>
    <td align="center">
      <a href="images/field-use/den-molodezhi-001.jpg"><img src="images/field-use/den-molodezhi-001.jpg" width="230" alt="Посетители играют на нескольких планшетах с первым поколением GameSpace на Дне молодёжи"></a>
      <br><strong>GameSpace у посетителей</strong>
    </td>
    <td align="center">
      <a href="images/field-use/den-molodezhi-004.jpg"><img src="images/field-use/den-molodezhi-004.jpg" width="320" alt="Четыре планшета с первым поколением GameSpace на открытой площадке"></a>
      <br><strong>Четыре планшета на площадке</strong>
    </td>
    <td align="center">
      <a href="images/field-use/den-molodezhi-005.jpg"><img src="images/field-use/den-molodezhi-005.jpg" width="230" alt="Посетители используют игры GameSpace на планшетах под открытым небом"></a>
      <br><strong>Игры без внешнего интернета</strong>
    </td>
  </tr>
</table>

Полевой запуск выявил ограничение, которое не проявлялось при испытаниях в
помещении: под прямыми солнечными лучами экраны сильно бликовали, а планшеты
нагревались. Для следующего использования на открытой площадке нужен навес или
другое устойчивое затенение. Лица посетителей на публичных копиях фотографий
размыты.

## GameSpace и другие проекты на мероприятии

На мероприятии автор использовал GameSpace APK и GameSpace PWA вместе с
программами из других своих проектов. Посетители играли на нескольких
планшетах: на снимках видны «Киберрефлекс», игры с игровым полем и задания с
текстовой графикой. Рядом с устройствами размещены печатные материалы и карточки
с QR-кодами проектов.

Роль GameSpace в такой подборке — установка и запуск подготовленного локального
HTML/CSS/JavaScript-содержимого. Сами игры, задания и их механика относятся к
загруженному содержимому и другим авторским разработкам. Это позволяет
использовать оболочку для разных программ на одной игровой площадке.

В галерее показаны общий вид площадки, участники за игрой и содержимое экранов
планшетов крупным планом.

<table>
  <tr>
    <td align="center" width="50%">
      <a href="images/field-use/event-20260905-overview.webp"><img src="images/field-use/event-20260905-overview.webp" width="360" alt="Общий вид игровой площадки: посетители собрались у стола с планшетами; лица размыты"></a>
      <br><strong>Игровая площадка</strong>
    </td>
    <td align="center" width="50%">
      <a href="images/field-use/event-20260905-visitors.webp"><img src="images/field-use/event-20260905-visitors.webp" width="360" alt="Участники пробуют разные игры на трёх планшетах за одним столом; лица размыты"></a>
      <br><strong>Участники у планшетов</strong>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <a href="images/field-use/event-20260905-playing.webp"><img src="images/field-use/event-20260905-playing.webp" width="360" alt="Вид сверху: участники играют в Киберрефлекс и выполняют задание на трёх планшетах"></a>
      <br><strong>В процессе игры</strong>
    </td>
    <td align="center" width="50%">
      <a href="images/field-use/event-20260905-tablets.webp"><img src="images/field-use/event-20260905-tablets.webp" width="360" alt="Крупный план планшетов: Киберрефлекс с результатом 324 миллисекунды, игра с полем и задание с текстовой графикой"></a>
      <br><strong>Игры и задания крупным планом</strong>
    </td>
  </tr>
</table>

Рассказ автора о мероприятии: [публикация во ВКонтакте](https://vk.ru/id4022887?w=wall4022887_1756).

Для документации отобраны фотографии из локальной подборки проекта. На
публичных копиях лица размыты; изображения уменьшены для просмотра на GitHub.
Нажатие на фотографию открывает её отдельным файлом.
...
Приложения принимают один цельный незашифрованный архив со стартовой страницей
`.html`. Допустимые варианты структуры и порядок выбора описаны в
