...
test("diagnostic controls exist on both app and landing surfaces, with manual-copy fallback", async () => {
  ...
  for (const id of ["diagnosticDialog", "diagnosticText", "diagnosticCopy", "diagnosticShare", "diagnosticClose", "lastErrorButton", "landingLastErrorButton", "errorDetailsButton", "manualReportButton", "landingReportButton"]) {
